...
import com.party.App.util.PartyResourseNotExistException;
...
public class PoliticalPartyController {
	...
	@GetMapping(value="/getParty/{partyId}")
	public PartyRequectVO getPartyDetails(@PathVariable Integer partyId) {
		PartyRequectVO statusVo=partyService.getPartyDetailsById(partyId);
		return statusVo;
	}


	@DeleteMapping(value="/deleteParty/{partyId}",produces=MediaType.APPLICATION_JSON_VALUE)
	public StatusDto deletePartyById(@PathVariable Integer partyId) {
